    ...
    return (
        <div>
            ...
            <ul>
                ...
                <li className="center text text-danger">e.g <b>XCS601</b> (career skills) <i className="bi bi-arrow-right"></i> <b>XCS601Q</b> (career skills Quant) && <b>XCS601V</b> (career skills Verbal)</li>
