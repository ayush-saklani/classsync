const createFooter = () => {
	...
	footer.innerHTML = `
        	<a class="d-inline-flex align-items-center mb-2 text-body-emphasis text-decoration-none" href="/">
				...
				<h2 class="my-3 heading-text fs-5 mx-2 text">Class-Sync Timetable Manager</h2>
			</a>
			<ul class="list-unstyled small">
				<li class="text mb-2 fw-semibold">Designed and built with all the love and passion in the world by <a
						class="link-danger fw-bold" href="https://github.com/ayush-saklani">ayush-saklani</a> <b class="text-dark">X</b> <a
						class="link-primary fw-bold" href="https://github.com/RawatDevanshu">RawatDevanshu</a>.</li>
				<li class="text mb-2 fw-semibold">Currently v1.8.0.</li>
			</ul>
			<ul class="h4 list-unstyled d-flex">
				...
				<p class="mx-2"> <b class="text-dark"> X </b> </p>
