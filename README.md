...
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nodejs/nodejs-original-wordmark.svg"height="75"/>
<!-- <i class="devicon-nodejs-plain-wordmark colored" style="font-size: 80px;"></i> -->
<i class="devicon-express-original"style="font-size: 80px; font-weight:bold ;"></i>
<i class="devicon-mongodb-plain-wordmark colored"style="font-size: 80px;"></i>
<i class="devicon-mongoose-original-wordmark colored"style="font-size: 80px;"></i>          
